...
- Paths under route groups use parentheses, for example `src/app/(public)/...`. On PowerShell, always quote those paths when passing them to `git add`, `git restore`, and similar commands.
...
- `Use accurate-commits and land this on main.`
