  ...
  return (
    <div className="mb-3 flex gap-2 rounded-lg border border-border/80 bg-card px-3 py-2.5 shadow-sm md:hidden">
      ...
      <button
        type="button"
        onClick={dismiss}
        className="inline-flex min-h-11 min-w-11 shrink-0 touch-manipulation items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 outline-none"
