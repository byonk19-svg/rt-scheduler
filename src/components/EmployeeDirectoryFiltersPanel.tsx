...
type EmployeeDirectoryTab = 'all' | 'day' | 'night'

export function EmployeeDirectoryFiltersPanel({
  employmentFilter,
  fmlaOnly,
  includeInactive,
  leadOnly,
  ...
  onFmlaOnlyChange: (checked: boolean) => void
  onIncludeInactiveChange: (checked: boolean) => void
  onLeadOnlyChange: (checked: boolean) => void
  onSearchTextChange: (value: string) => void
  onTabChange: (value: EmployeeDirectoryTab) => void
  searchText: string
  sortedEmployeesCount: number
  ...
  return (
    <>
      ...
      <p className="text-xs font-medium text-muted-foreground">
        {sortedEmployeesCount} employee(s)
      </p>
    </>
  )
}
