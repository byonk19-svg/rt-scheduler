...
function compactPrimaryCtaForContext(context: AttentionContext, snapshot: ManagerAttentionSnapshot) {
...
function metricsForContext(context: AttentionContext, snapshot: ManagerAttentionSnapshot): MetricLink[] {
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            {metrics.map((metric) => (
              <Link
                ...
                href={metric.href}
                className={cn(metricLinkClass(), metric.emphasized ? 'font-semibold text-foreground' : 'text-foreground')}
