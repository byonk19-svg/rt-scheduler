...
describe('ManagerSchedulingInputs performance contract', () => {
  it('lazy-loads the queue and therapist detail surface instead of statically importing them into the manager shell', () => {
    ...
    expect(source).not.toContain('manager-availability-editor-dialog')
  })
})
