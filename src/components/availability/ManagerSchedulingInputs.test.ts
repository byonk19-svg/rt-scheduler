...
describe('ManagerSchedulingInputs', () => {
  it('renders the queue-first manager workspace with toolbar, queue, detail panel, and inline editor', () => {
    ...
    expect(html).toContain('Availability checklist')
    expect(html).toContain('Work left to right: collect responses, review requests')
    expect(html).toContain('1. Collect')
    expect(html).toContain('2. Review')
    expect(html).toContain('3. Edit')
    expect(html).toContain('1 therapist missing | 1 submitted')
    ...
    expect(panelSource).toContain('const hasExistingSelections')
    expect(panelSource).toContain('hasExistingSelections,')
    expect(panelSource).toContain('const selectedDatesHaveSelections')
    expect(panelSource).toContain('hasExistingSelections: selectedDatesHaveSelections')
