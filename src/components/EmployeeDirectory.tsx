...
import { EmployeeDeactivateDialog } from '@/components/employee-directory/EmployeeDeactivateDialog'
import { EmployeeDirectoryFilters } from '@/components/employee-directory/EmployeeDirectoryFilters'
import { MissingAvailabilityPanel } from '@/components/employee-directory/MissingAvailabilityPanel'
import { EmployeeOverridesPanel } from '@/components/employee-directory/EmployeeOverridesPanel'
import {
    ...
    <Card id="employee-directory">
      ...
      <CardContent className="space-y-4">
        <EmployeeDirectoryFilters
          ...
          onFmlaOnlyChange={setFmlaOnly}
          onIncludeInactiveChange={setIncludeInactive}
          onLeadOnlyChange={setLeadOnly}
        ...
        <MissingAvailabilityPanel
          collapsed={collapsedMissing}
          cycles={cycles.map((cycle) => ({ id: cycle.id, label: cycle.label }))}
          rows={missingAvailabilityRows}
          selectedCycleId={selectedAvailabilityCycleId}
          formatDateTime={formatDateTime}
          onCycleChange={setAvailabilityCycleId}
          onEditAvailability={(therapistId) =>
            openEditForEmployee(therapistId, {
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto p-0 sm:max-w-xl">
          ...
          {editEmployee && (
            <>
              ...
              {/* ── Overrides tab panel ── */}
              {drawerTab === 'overrides' && editEmployee && (
                <EmployeeOverridesPanel
                  ...
                  setCopySourceCycleId={setCopySourceCycleId}
                  setCopyTargetCycleId={setCopyTargetCycleId}
                  setOverrideCalendarMonthStart={setOverrideCalendarMonthStart}
                  setOverrideCycleIdDraft={setOverrideCycleIdDraft}
                  setOverrideDateDraft={setOverrideDateDraft}
                  setOverrideDateError={setOverrideDateError}
                  setOverrideDatesDraft={setOverrideDatesDraft}
                  addDateToOverrideBatch={addDateToOverrideBatch}
                  handleCalendarDayMouseDown={handleCalendarDayMouseDown}
                  handleCalendarDayMouseEnter={handleCalendarDayMouseEnter}
                  handleCalendarDayTouchStart={handleCalendarDayTouchStart}
                />
              )}
            </>
          )}
