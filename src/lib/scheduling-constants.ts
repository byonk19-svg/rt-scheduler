...
export function getDefaultWeeklyLimitForEmploymentType(employmentType: string | null | undefined): number {
...
export function sanitizeWeeklyLimit(value: number | null | undefined, fallback: number = MAX_WORK_DAYS_PER_WEEK): number {
