...
describe('pickTherapistForDate', () => {
  ...
  it('blocks weekday assignments when offs_dow marks that weekday unavailable', () => {
  ...
  it('prefers the lower-penalty pattern match when weekly counts are tied', () => {
    const therapists: Therapist[] = [
      buildTherapist({
        id: 'soft-non-match',
  ...
  it('blocks alternating weekend off-weeks without explicit overrides', () => {
    const therapist = buildTherapist({
