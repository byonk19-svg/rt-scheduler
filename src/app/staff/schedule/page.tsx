              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: 14, fontWeight: 800, color: '#0f172a', lineHeight: 1 }}
                    >
                      {shift.dayNum || '—'}
                    </span>
                  </span>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>
                      {shift.isLead ? 'You are lead' : `Lead: ${shift.lead}`}
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <div style={{ marginTop: 6, display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ fontSize: 13, fontWeight: 700, color: '#0f172a' }}>
                          {shift.isLead ? 'You (Lead)' : shift.lead}
                        </span>
                      </div>
                    </div>
                        ...
                        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                          {shift.crew.map((name) => (
                            ...
                            >
                              ...
                              <span style={{ fontSize: 11, color: '#fafaf9', fontWeight: 600 }}>
                                {name}
                              </span>
                            </span>
                          ))}
