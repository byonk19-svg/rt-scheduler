...
describe('onboarding route copy', () => {
  ...
  it('locks the onboarding hub copy and required step labels', () => {
    ...
    expect(setupSource).toContain('Repeating cycle')
    expect(setupSource).toContain('Pick your work days on the next step.')
    expect(setupSource).toContain('Set the pattern next')
    expect(setupSource).toContain('This panel updates after you choose your work days.')
    ...
    expect(setupSource).toContain('Pick how you usually work.')
