...
import PublishHistoryPage from '@/app/(app)/publish/history/page'
...
describe('PublishHistoryPage', () => {
  ...
  it('renders delivery history entries and controls', async () => {
    ...
    expect(html).toContain('Publish delivery history')
    expect(html).toContain('Delete history')
    expect(html).toContain('No longer live')
    expect(html).toContain('Currently live')
