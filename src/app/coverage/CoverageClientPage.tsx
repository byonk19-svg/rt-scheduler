...
export function CoverageClientPage({
  ...
  const [coverageReloadNonce, setCoverageReloadNonce] = useState(0)
  ...
  }, [cycleFromUrl, supabase, clearLoadedScheduleState, coverageReloadNonce])
