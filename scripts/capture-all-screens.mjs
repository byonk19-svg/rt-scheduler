...
const MANAGER_SHOTS = [
  ...
  { name: '12-manager-coverage-week', path: '/coverage?view=week' },
  {
    name: '13-manager-coverage-needs-attention',
    path: '/coverage?view=week&filter=needs_attention&focus=first',
  },
  { name: '14-manager-roster-view', path: '/schedule' },
...
const STAFF_SHOTS = [
  ...
  { name: '43-staff-my-shifts', path: '/therapist/schedule' },
  { name: '44-staff-my-shifts-alias', path: '/staff/my-schedule' },
  { name: '45-staff-schedule-alias', path: '/staff/schedule' },
  { name: '46-staff-coverage-week', path: '/coverage?view=week' },
  { name: '47-staff-roster-view', path: '/schedule' },
