-- Harden authorization boundaries for profile role edits and designated lead mutation.
...
begin
  ...
  if not actor_is_manager
     and (
       ...
       or new.is_lead_eligible is distinct from old.is_lead_eligible
    ...
    raise exception 'Only managers can update role and staffing eligibility fields.'
      using errcode = '42501';
  end if;
...
begin
  if not public.is_manager() then
    raise exception 'Only managers can set designated lead.' using errcode = '42501';
  end if;
